 ...
 * @description :
 */
public class TestOrganItemRadarTablePolicy {
    public static void main(String[] args) throws IOException {
        ...
        HashMap<String, Object> data = new HashMap<String, Object>() {
            {
                // 构建 table
                OrganItemRadarTablePolicy organItemRadarTablePolicy = new OrganItemRadarTablePolicy();
                builder.bind("table", organItemRadarTablePolicy);
            }
        };
