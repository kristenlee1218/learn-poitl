 ...
 * @description :
 */
public class OrganItemRadarTablePolicy extends AbstractRenderPolicy<Object> {
    int col = item.length + 2;
    int row = 3;
    public static String[] item = new String[]{"政治忠诚", "政治担当", "社会责任", "改革创新", "管理效能", "风险管控", "选人用人", "基层党建", "团结协作", "联系群众"};
