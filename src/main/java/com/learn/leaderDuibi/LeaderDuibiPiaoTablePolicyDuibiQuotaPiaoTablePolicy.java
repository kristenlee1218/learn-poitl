 ...
 */
public class LeaderDuibiPiaoTablePolicyDuibiQuotaPiaoTablePolicy extends AbstractRenderPolicy<Object> {
            ...
            if (group.length > 0) {
                for (int i = 0; i < items.length; i++) {
                    ...
                    for (int j = 0; j < items[i].length; j++) {
                        if (index - 5 - i < 9) {
                            str[++index] = "{{avg_leader0" + (index - 5 - i) + "_" + voteType + "_" +  + k + "}}";
                        } else {
                            str[++index] = "{{avg_leader" + (index - 5 - i) + "_" + voteType + "_" +  + k + "}}";
                        }
                    }
                    index++;
                }
